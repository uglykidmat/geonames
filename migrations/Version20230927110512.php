 ...
 */
final class Version20230927110512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE geonames_country_level SET max_level = 1 WHERE max_level = 0');
        $this->addSql('UPDATE geonames_country_level SET used_level = 1 WHERE used_level = 0');
    }
