...
//_____________________Test for subfolder links...
// $allCountriesTxtUrl = pathinfo('base_data/allCountries.txt');
// $allCountriesTxtLink = "./".$allCountriesTxtUrl["dirname"]."/".$allCountriesTxtUrl["basename"];

//_____________________Echodumps
// echo "<pre>";
// var_dump ($allCountriesTxtUrl);
// echo "</pre>";
// echo "testCountriesTxtLink : ".$allCountriesTxtLink." - ".gettype($allCountriesTxtLink) ."<br/><br/>";
...
//_____________________In order to get countryCodes array directly from file...:
// $countryCodes = str_split(file_get_contents("countryCodes.txt"));
// echo "CountryCodes : ".$countryCodes;
